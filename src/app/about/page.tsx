...
export default function Page() {
  return (
    <div className="mx-auto mt-fluid-6 flex max-w-screen-md flex-col gap-10">
      ...
      <Separator />
      <section className="flex max-w-prose flex-col gap-6 text-sm !leading-8 text-2">
        <p>
        ...
        <p>
          ...
          <em className="px-1 text-xs">(maintained internally)</em>. These new posts are then passed
          through GPT to generate a short summary and identify the most relevant topic. The goal
          here is to identify trends and quickly consume content without having to navigate
          externally.
        </p>
      </section>
    </div>
